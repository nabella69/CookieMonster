...
CM.Cache.AddQueue = function() {
	...
	CM.Cache.Queue.setAttribute('src', 'http://nabella69.github.io/CookieMonster/queue/queue.js');
...
CM.Disp.AddJscolor = function() {
	...
	CM.Disp.Jscolor.setAttribute('src', 'http://nabella69.github.io/CookieMonster/jscolor/jscolor.js');
...
CM.Disp.UpdateFavicon = function() {
	if (CM.Config.Favicon == 1 && CM.Disp.lastGoldenCookieState) {
		if (CM.Disp.goldenShimmer.wrath) {
			CM.Disp.Favicon.href = 'http://nabella69.github.io/CookieMonster/favicon/wrathCookie.ico';
		}
		else {
			CM.Disp.Favicon.href = 'http://nabella69.github.io/CookieMonster/favicon/goldenCookie.ico';
		}
	}
	else {
		CM.Disp.Favicon.href = 'http://orteil.dashnet.org/cookieclicker/favicon.ico';
